...
[Remote Proxy]
云通 = https://ytytytsubs.com/yt?token=544f3b41578bfe999a084e7bcfe174ca,udp=true,block-quic=false,fast-open=default,vmess-aead=true,skip-cert-verify=true,enabled=true,flexible-sni=false
